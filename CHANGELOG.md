...
### Improvements
  ...
  - the overlap check works on any orderable column type, now covered by specs for integer and string ranges (including open-ended ones) and documented in the README ("non-date ranges")
